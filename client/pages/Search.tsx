...
import { Calendar, ArrowLeft, MapPin, Users, Star, Heart, Search as SearchIcon } from "lucide-react";
...
const allVenues = [
  ...
  // Puedes agregar más salones aquí si lo deseas
];
...
export default function Search() {
  ...
  // Filtra por ciudad y por nombre si el usuario busca algo
  const filteredVenues = allVenues.filter((venue) => {
    const matchesCity = ciudad === "" || venue.location.toLowerCase().includes(ciudad);
    const matchesSearch =
      searchTerm === "" || venue.name.toLowerCase().includes(searchTerm.toLowerCase());
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground font-body">
            {filteredVenues.length} salones encontrados en Chihuahua, Chih.
          </p>
        </div>
